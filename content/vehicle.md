...
#### Request
```curl
curl -u APP_ID:APP_SECRET -X GET "https://platform.vin.li/api/v1/devices/821374c0-d6d8-11e3-9c1a-0800200c9a66/vehicles"
```
...
#### Request
```curl
curl -u APP_ID:APP_SECRET -X GET "https://platform.vin.li/api/v1/devices/821374c0-d6d8-11e3-9c1a-0800200c9a66/vehicles/_latest"
```
...
```json
{
    "vehicle": {
        ...
        "lastStartup": "2017-03-01T18:26:44.967Z"
    }
}
```
...
#### Request
```curl
curl -u APP_ID:APP_SECRET -X GET "https://platform.vin.li/api/v1/vehicles/67e1e940-d6da-11e3-9c1a-0800200c9a66"
```
